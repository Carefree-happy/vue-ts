...
export function retrieveSchema(schema: any, rootSchema = {}, formData: any = {}): Schema {
    ...
    const hasAdditionalProperties = Object.prototype.hasOwnProperty.call(resolveSchema, "additionalProperties") && resolvedSchema.additionalProperties !== false
...
export function stubExistingAdditionalProperties(schema: Schema, rootSchema: Schema = {}, formData: any = {}) {
    ...
    Object.keys(formData).forEach((key) => {
        ...
        } else if (Object.prototype.hasOwnProperty.call(schema, "type")) {
...
export function isConstant(schema: Schema) {
    return (Array.isArray(schema.enum) && schema.enum.length === 1) || Object.prototype.hasOwnProperty.call(schema, "const")
}
